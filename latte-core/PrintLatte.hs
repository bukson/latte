...
instance Print Stmt where
  prt i e = case e of
   ...
   For arg expr stmt -> prPrec i 0 (concatD [doc (showString "for") , doc (showString "(") , prt 0 arg , doc (showString ":") , prt 0 expr , doc (showString ")") , prt 0 stmt])
...
instance Print Expr where
  prt i e = case e of
   ENewArr type' expr -> prPrec i 7 (concatD [doc (showString "new") , prt 0 type' , doc (showString "[") , prt 0 expr , doc (showString "]")])
   ECast type' -> prPrec i 6 (concatD [doc (showString "(") , prt 0 type' , doc (showString ")null")])
   EArrGet expr0 expr -> prPrec i 6 (concatD [prt 6 expr0 , doc (showString "[") , prt 0 expr , doc (showString "]")])
